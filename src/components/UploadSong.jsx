    ...
    <div className="bg-[#10061E] w-[100%] h-[100vh] ">
      ...
      <div className="absolute inset-0  z-10">
        <div>
          ...
          <div className="w-full mt-[3vh]">
            <div className="text-center flex flex-col gap-9 mt-[14vh]">
              <div>
                <input
              ...
              <div className="flex gap-6 item-conter">
                <a
                  href="#"
                  class="relative items-center justify-start inline-block px-[2vw] py-[2vh] overflow-hidden font-bold rounded-md group"
                >
                  <span class="w-[20vw] h-32 rotate-45 translate-x-12 -translate-y-2 absolute left-0 top-0 bg-white opacity-[3%]"></span>
                  <span class="absolute top-0  left-0 w-[20vw] h-48 -mt-1 transition-all duration-500 ease-in-out rotate-[35deg] -translate-x-56 -translate-y-24 bg-red-400  opacity-100 group-hover:-translate-x-8"></span>
